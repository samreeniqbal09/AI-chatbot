...
function Sidebar({
  ...
  const handleAddToProject = (chat) => {
    setOpenMenu(null)
    console.log("Add chat to project:", chat.id)
  }
      ...
      >
        ...
        <div className="chat-history">
          <button
            ...
            type="button"
            onClick={() => setShowRecent((previous) => !previous)}
    ...
    >
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <button type="button" onClick={() => onTogglePin(chat.id)}>
              <Pin size={14} />
              <span>{pinned ? "Unpin" : "Pin"}</span>
            </button>

            <button type="button" onClick={() => onRename(chat)}>
              <Pencil size={14} />
              <span>Rename</span>
            </button>

            <button type="button" onClick={() => onAddToProject(chat)}>
              <FolderPlus size={14} />
